 ...
 */
/**
 * Every Gmail node executor — the PHP twin of `GMAIL_RUNNABLE_KINDS` in
 * @particle-academy/gmail-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `GmailFlow::register($kinds, $executors)` — one call, no directory scan.
 ...
 */
final class GmailFlow
{
    /** @var list<class-string> */
    public const EXECUTORS = [
        MessageExecutor::class,
    ];
